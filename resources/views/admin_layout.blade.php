...
<link rel="stylesheet" href="{{asset('public/backend/css/bootstrap-reboot.css')}}" >
...
<link rel="stylesheet" href="{{asset('public/backend/css/font-awesome.css')}}" type="text/css"/>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">               
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/admin-add-menu')}}">Add menu</a></li>
						<li><a href="{{URL::to('/admin-all-menu')}}">All menu</a></li>
